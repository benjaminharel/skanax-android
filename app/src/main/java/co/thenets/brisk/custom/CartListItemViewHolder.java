...
public class CartListItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    public View view;
    ...
    // Footer related views
    public TextView productsPriceTextView;
    public TextView deliveryPriceTextView;
    public TextView totalPriceTextView;
    public Button orderCartButton;
    public CartActionsListener listener;

    public CartListItemViewHolder(View itemView, CartActionsListener cartActionsListener)
    {
        super(itemView);
        view = itemView;
        listener = cartActionsListener;
        ...
        productsPriceTextView = (TextView) itemView.findViewById(R.id.productsPriceTextView);
        deliveryPriceTextView = (TextView) itemView.findViewById(R.id.deliveryPriceTextView);
        totalPriceTextView = (TextView) itemView.findViewById(R.id.totalPriceTextView);
        orderCartButton = (Button) itemView.findViewById(R.id.orderCartButton);
        orderCartButton.setOnClickListener(this);
    }
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.orderCartButton:
                listener.onOrderPressed(getAdapterPosition());
                break;
        }
    }
}